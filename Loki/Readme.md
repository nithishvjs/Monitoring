...
Script.py file is a random log generator file used for test the loki.
Promtail is same as node exporter for loki to get logs from other servers.
Loki-config file is defaultely on loki download page(dont want to change).
